...
service AuthorizationService @(path: '/odata/v4/auth') {
  ...
  action fetchBdcRelationalValues(
    url          : String,
    tokenUrl     : String,
    clientId     : String,
    clientSecret : String,
  ...
  action fetchRawBdcRelationalValues(
    url          : String,
    tokenUrl     : String,
    clientId     : String,
    clientSecret : String,
  ...
  action fetchRawBdcAssetColumns(
    url          : String,
    tokenUrl     : String,
    clientId     : String,
    clientSecret : String,
