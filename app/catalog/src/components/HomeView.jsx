...
export default function HomeView({ setActiveNav, onCreateRole, navigateToRoles }) {
  ...
  const cards = [
    ...
    { label: 'Users & assignments overview', icon: Users, color: '#10b981', bg: 'rgba(16, 185, 129, 0.04)', border: 'rgba(16, 185, 129, 0.15)', tab: 'assignments', size: 6 },
    { label: 'Organizational Nodes', value: stats?.nodeCount || 0, icon: Building2, color: '#a78bfa', bg: 'rgba(167, 139, 250, 0.04)', border: 'rgba(167, 139, 250, 0.15)', tab: 'org', size: 6 },
  ];
        ...
        {isHealthCard && stats ? (
          <Box sx={{ mt: 1.5 }}>
            <Grid container spacing={3}>
              ...
              >
                <Typography variant="caption" sx={{ fontWeight: 1, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'text.secondary' }}>
                  Total Roles
                </Typography>
