...
import { Settings, Network, Cloud, Terminal, GitFork, Database } from 'lucide-react';
  ...
  if (TABS.length === 0) {
    return (
      <Box sx={{ p: 4, textAlign: 'center', bgcolor: 'rgba(239, 68, 68, 0.05)', border: '1px solid rgba(239, 68, 68, 0.2)', borderRadius: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary">You do not have system administration privileges in this application.</Typography>
      </Box>
    );
  }
